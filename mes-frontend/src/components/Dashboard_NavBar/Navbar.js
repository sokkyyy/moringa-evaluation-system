  ...
  return (
    ...
    <div>
      ...
      <nav className="mb-1 navbar navbar-expand-lg navbar-dark">
        ...
        <a className="navbar-brand" href="#"><img src={logo} alt="moringa-school-logo" id="logo"/></a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent-333">
          ...
          <ul className="navbar-nav mr-auto">
            <li className="nav-item">
              <a className="nav-link" href="#" id="app_name">mes
          ...
          <ul className="navbar-nav ml-auto nav-flex-icons">
            ...
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu dropdown-default" aria-labelledby="navbarDropdownMenuLink-333">
                <a className="dropdown-item" href="#">My Reports</a>
                <a className="dropdown-item" href="#">Team Reports</a>
                <a className="dropdown-item" href="#">Company Reports</a>
              </div>
            </li>
            
            <li className="nav-item dropdown">
              <a className="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">Assessment
              </a>
              <div className="dropdown-menu dropdown-default" aria-labelledby="navbarDropdownMenuLink-333">
